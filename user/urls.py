...
urlpatterns = [
    ...
    url(r'^logg-inn/$', auth_views.LoginView.as_view(template_name='user_login.html', redirect_authenticated_user=True), name='user.login'),
    url(r'^logg-ut/$', auth_views.LogoutView.as_view(next_page='/'), name='user.logout'),
