...
class RegistrationForm(forms.ModelForm):
    ...
    spam_bot_check = forms.IntegerField(required=True, validators=[spam_bot_validator], widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Svaret på oppgaven', 'required': 'true'}))
